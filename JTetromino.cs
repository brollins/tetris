...
namespace Tetris
{
    public class JTetromino : Tetromino
    {
        ...
        public JTetromino(Canvas canvas, Collection<Tetromino> tetrominosOnScreen) : base(canvas, tetrominosOnScreen)
        {
        ...
        {
            JTetromino jtetromino = new JTetromino(canvas, tetrominosOnScreen);
            jtetromino.Color = this.Color;
            return jtetromino;
        }
    }
}
